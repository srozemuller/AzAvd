function Export-AvdConfig {
    ...
    Process {
        ...
        $Content = [ordered]@{
            ...
            Network      = Get-AvdNetworkInfo @Parameters | Select-Object Name, ResourceGroup, @{N="privateIPAddress";E={$_.networkcardinfo.privateIPAddress}}, @{N="privateIPAddress";E={$_.networkcardinfo.nicId}}, @{N="subnetNsgId";E={$_.SubnetInfo.networksecurityGroup}}, @{N="subnetId";E={$_.networkcardinfo.subnet.id}}
        }
