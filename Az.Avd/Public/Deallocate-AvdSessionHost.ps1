function Deallocate-AvdSessionHost {
    ...
    .DESCRIPTION
    This function deallocates sessionshosts in a specific Azure Virtual Desktop hostpool. If you want to deallocate a specific session host then also provide the name, 
    ...
    .EXAMPLE
    Deallocate-AvdSessionHost -HostpoolName avd-hostpool-personal -ResourceGroupName rg-avd-01
    .EXAMPLE
    Deallocate-AvdSessionHost -HostpoolName avd-hostpool-personal -ResourceGroupName rg-avd-01 -SessionHostName avd-host-1.avd.domain
    #>
