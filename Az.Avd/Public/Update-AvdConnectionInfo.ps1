function Update-AvdConnectionInfo {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Update-AvdConnectionInfo -hostpoolname avd-hostpool -resourceGroupName rg-avd-01 -CustomRdpProperty "targetisaadjoined:i:1"
    #>
    [CmdletBinding()]
    param
    (
