...
BeforeAll {
    $skipFiles = @("Connect-Avd.ps1","Start-AvdSessionHost.ps1","Stop-AvdSessionHost.ps1","Get-AvdSessionHost.ps1","Get-AvdSessionHostResources.ps1","Get-AvdSessionHostPowerState.ps1","Remove-AvdSessionHost.ps1")
}
